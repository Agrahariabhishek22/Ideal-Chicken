...
const InsightsBanner = () => {
  ...
  return (
    <div className="w-full bg-white flex justify-center items-center py-10 px-2 font-sans overflow-hidden">
      {/* Animation Styles */}
      <style>{`
        @keyframes fadeInUp {
      ...
      {/* Main Container */}
      <div className="w-full max-w-[1400px] flex flex-col md:flex-row justify-between items-end gap-10">
        
        {/* Left Side Content */}
        <div className="flex flex-col gap-6">
          
          {/* Badge - (Animation Added Here) */}
          ...
          {/* Heading Area with IMAGE ICON - (Animation Added Here) */}
          <div className="flex items-center gap-5 opacity-0 animate-fade-up delay-200">
            ...
            {/* Title */}
            <h1 className="text-[#141414] text-4xl font-bold tracking-tight">
              Insights & Stories
            </h1>
          </div>
        </div>

        {/* Right Side Content (Description) - (Animation Added Here) */}
        <div className="max-w-[520px] mb-1 opacity-0 animate-fade-up delay-300">
          <p className="text-[#4B0736] text-lg font-medium leading-relaxed">
