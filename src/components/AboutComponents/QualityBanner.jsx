  ...
  return (
    <section className="w-full px-4 md:px-3 py-8">
      ...
      >
        ...
        {/* Content Container */}
        <div className="relative z-10 w-full px-6 md:px-16 py-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          
          {/* Left Side: Text Content */}
          <div className="max-w-lg flex flex-col gap-3">
            <h2 className="text-3xl font-bold text-[#FEFEFE] leading-tight">
              Quality You Can Trust
            </h2>
            <p className="text-[#FEFEFE] text-sm md:text-base  font-medium leading-relaxed">
              Certified processes and stringent quality controls ensure every product meets the highest standards
            </p>
          </div>
          ...
          <div className="mt-4 md:mt-0">
            <button className="group bg-[#262626] hover:bg-black text-[#FEFEFE] px-6 py-3 rounded-full text-sm md:text-base font-bold transition-all duration-300 flex items-center gap-2 shadow-lg">
              Partner with us
