            ...
            navItems.map((item) => (
              <li key={item.id} className="relative group">
                ...
                >
                  {item.label}
                  {item.hasDropdown && (
                    <ChevronDown className="ml-1 w-4 h-4 text-[#D21E4B] transition-transform duration-300 group-hover:-rotate-180" />
                  )}
                </a>
                ...
                {item.hasDropdown && (
                  <motion.div
                    ...
                    className="absolute z-10 left-0 top-full pt-4 hidden group-hover:block"
                  >
