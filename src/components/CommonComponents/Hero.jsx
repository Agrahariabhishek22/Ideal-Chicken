  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col item-center justify-center z-10 max-w-5xl mx-auto px-6 py-10 sm:py-20 lg:py-20 text-center h-full">
        ...
        <div>
          <h1 className={`text-3xl sm:text-4xl md:text-5xl font-semibold ${badge=="Our Products"?"text-[#FEFEFE]":"text-[#A71077]"} leading-tight  mb-4 w-[60%] mx-auto`}>
          {
            <>
              {title}
            </>
        ...
        <p className={`" max-w-2xl mx-auto ${badge=="Our Products"?"text-[#FEFEFE]":"text-[#5F0944]"} text-md sm:text-base text-[#5F0944] font-medium w-[5%]"`}>
          {subtitle}
        </p>
      </div>
    </section>
